...
public class ModGolemModel<T extends GolemMob> extends CompositeEntityModel<T> {
    ...
    @Override
    public void setAngles(T BaseGolem, float f, float g, float h, float i, float j) {
    ...
    @Override
    public void animateModel(T BaseGolem, float f, float g, float h) {
        int i = BaseGolem.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = BaseGolem.getLookingAtVillagerTicks();
            if (j > 0) {
