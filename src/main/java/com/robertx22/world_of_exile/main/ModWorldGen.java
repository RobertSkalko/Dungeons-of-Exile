...
public class ModWorldGen {
    ...
    public StructureProcessorType<HellOnlyBiomeProcessor> HELL_ONLY_BIOME_PROCESSOR = StructureProcessorType.register(WOE.MODID + ":hell_only_biome_processor", HellOnlyBiomeProcessor.CODEC);
