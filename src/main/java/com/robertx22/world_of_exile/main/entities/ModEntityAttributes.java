...
public class ModEntityAttributes {
    ...
    public static void register() {
        ...
        FabricDefaultAttributeRegistry.register(ModEntities.INSTANCE.FIRE_GOLEM, BaseGolem.createBossAttributes());
        FabricDefaultAttributeRegistry.register(ModEntities.INSTANCE.FROST_GOLEM, BaseGolem.createBossAttributes());

        FabricDefaultAttributeRegistry.register(ModEntities.INSTANCE.REDSTONE_GOLEM, EndermanEntity.createEndermanAttributes());
